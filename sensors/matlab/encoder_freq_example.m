...
F0 = 0.18;
F1 = 0.0;
yA = chirp(tt,F0,Texp/2.5, F1, 'quadratic', 45, 'concave');
yB = chirp(tt,F0,Texp/2.5, F1, 'quadratic', 90, 'concave');
...
minpdist = 3;
[dArpks,iAr] = findpeaks(dA, 'MinPeakDistance', minpdist, 'MinPeakHeight',0.3);
[dAfpks,iAf] = findpeaks(-dA, 'MinPeakDistance',minpdist, 'MinPeakHeight',0.3);
hold on
...
[dBrpks,iBr] = findpeaks(dB, 'MinPeakDistance',minpdist, 'MinPeakHeight',0.3);
[dBfpks,iBf] = findpeaks(-dB, 'MinPeakDistance',minpdist, 'MinPeakHeight',0.3);
hold on
...
dlmwrite('../../figures/chirpdata2.dat', data, ',');
...
filenames = {'../../figures/chirpdata2_dt1.dat', '../../figures/chirpdata2_dt2.dat'};
for i = 1:2
    dt = dts(i);
    ti = 0:dt:tend;
