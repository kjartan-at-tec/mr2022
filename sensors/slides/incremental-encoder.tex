...
\label{sec:orga55b09e}
\begin{frame}[label={sec:org090471e}]{Sensores}
\begin{center}
...
\begin{frame}[label={sec:orgbf697ad}]{Sensores}
\begin{center}
\begin{tikzpicture}[scale=0.6, node distance=22mm, block/.style={rectangle, draw, minimum width=15mm, inner sep=4pt}, sumnode/.style={circle, draw, inner sep=2pt}]
...
\begin{frame}[label={sec:org45cc6c7}]{Sensores - características}
\begin{itemize}
\item \alert{Exactitud} Que tán correcto es en promedio.  \alert{Precisón} Desviación del error.
\item \alert{Sensibildad} El cambio más pequeño en la señal que se puede detectar.
