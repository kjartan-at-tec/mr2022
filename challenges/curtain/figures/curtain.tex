...
\begin{document}
  \begin{tikzpicture}[scale=4]
    ...
    \node[] at (0.5*\bb,0.5*\aa)  {\includegraphics[width=6.3 cm]{manufacture.jpg}};
    ...
    \begin{scope}[yshift=\hh cm]
      ...
      % The window
      \fill[ball color=black!10, opacity=0.4] (\framewidth,\windowstart) -- (\bb+\framewidth,\windowstart)
